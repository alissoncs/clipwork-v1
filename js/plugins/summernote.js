...
(function (factory) {
    ...
    lang: {
      'en-US': {
        ...
        image: {
          ...
          selectFromFiles: 'Upload de imagem',
          url: 'Link da Imagem',
          remove: 'Remove Image'
        },
        link: {
        ...
        color: {
          ...
          reset: 'Resetar',
          resetToDefault: 'Resetar para o padrão'
        },
        shortcut: {
    ...
    var attachDragAndDropEvent = function (oLayoutInfo) {
      ...
      $document.on('dragenter', function (e) {
        ...
        if (!bCodeview && !collection.length) {
          ...
          $dropzoneMessage.text('Arraste imagem');
        }
  ...
  var Renderer = function () {
    ...
    var tplDialogs = function (lang, options) {
      var tplImageDialog = function () {
        var body = '<label><span>' + lang.image.selectFromFiles + '</span>' +
                   '<input class="note-image-input" type="file" name="files" accept="image/*" /></label>' +
                   '<label><span>' + lang.image.url + '</span>' +
                   '<input class="note-image-url form-control span12" type="text" /></label>';
        var footer = '<button href="#" class="btn note-image-btn disabled" disabled>' + lang.image.insert + '</button>';
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      sToolbar = '<div class="note-toolbar btn-toolbar" tabindex="2">' + sToolbar + '</div>';
  ...
  $.fn.extend({
    ...
    summernote: function (options) {
      ...
      // Insere botão de notas dentro do editor
